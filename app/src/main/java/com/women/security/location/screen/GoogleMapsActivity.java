package com.women.security.location.screen;
...
import com.women.security.location.GetNearbyPlaces;
import com.women.security.views.EmailActivity;
...
public class GoogleMapsActivity extends FragmentActivity implements
     ...
     private View main ;
    private ImageView screenshoot, sendscreenshoot;
...
// ASK PERMISSION FOR STORAGE ...
     ...
     // screenshoot and send .....button for onclick...listener...


     screenshoot = (ImageView)   findViewById(R.id.screenshoot);
     sendscreenshoot =(ImageView)findViewById(R.id.screenshoot_send);


     screenshoot.setOnClickListener(new View.OnClickListener() {
         @Override
         public void onClick(View v) {
             screenshoot.setVisibility(View.INVISIBLE);
             sendscreenshoot.setVisibility(View.VISIBLE);

                 View rootView = getWindow().getDecorView().findViewById(android.R.id.content);
                Bitmap bitmap = getscreenshoot(rootView);
                store(bitmap,"ScreenShoot.png");
     ...
     sendscreenshoot.setOnClickListener(new View.OnClickListener() {
         @Override
         public void onClick(View v) {
             Intent i=new Intent(GoogleMapsActivity.this, EmailActivity.class);
             startActivity(i);
         }
     });
    ...
    private String getUrl(double latitide, double longitude, String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyBqldszsR8VGHVuaX_Efj3h8NRzRHDLZdY");
